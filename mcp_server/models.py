...
#   timestamp: 2025-06-28T14:52:41+00:00
...
class CertificateParameters(BaseModel):
    CERT_TYPE: str = Field(
        ...
        examples=['NET-I_2018,NET-II_2018,NET_2019'],
    )
    FullName: str = Field(..., description='Full name', examples=['Sunil Kumar'])
    RROLL: str = Field(..., description='Roll No.', examples=['30701002XX'])
...
class MrcerCertificatePostRequest(BaseModel):
...
class MrcerCertificatePostResponse(BaseModel):
...
class MrcerCertificatePostResponse1(BaseModel):
...
class MrcerCertificatePostResponse2(BaseModel):
...
class MrcerCertificatePostResponse3(BaseModel):
...
class MrcerCertificatePostResponse4(BaseModel):
...
class MrcerCertificatePostResponse5(BaseModel):
...
class MrcerCertificatePostResponse6(BaseModel):
